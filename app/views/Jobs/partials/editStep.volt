    ...
    <div class="panel-body collapse"  id="step-{{ step['uid'] }}">
        <div class="form-group col-xs-10">
            <div class="checkbox">
                ...
                <input id="enable-step-{{ step['uid'] }}" class="tgl tgl-skewed js-step-toggle" type="checkbox" data-stepUid="{{ step['uid'] }}" {% if job['benchmark'] == 1 %}checked{% endif  %}/>
        ...
        <div class="col-xs-12">
            ...
            <div class="form-group col-lg-2 col-md-12 text-right">
                ...
                <input type="text" class="form-control text-right" placeholder="Last status" value="{{ step['lastExecution']['status']|default }}" readonly>
            </div>
        </div>
        ...
        <div class="col-xs-12">
            <table class="js-list-param table table-bordered">
                ...
                {% for parameter in step['parameters'] %}
                    {{ partial("Jobs/partials/editParameter", ['parameter': parameter, 'stepUid' : step['uid']]) }}
                {% endfor  %}
                <tr>
