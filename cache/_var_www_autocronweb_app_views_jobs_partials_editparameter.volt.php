<tr data-stepUid="<?= $stepUid ?>">
    ...
    <td valign="middle">
        <div class="switch">
            <input id="param-enabled-<?= $parameter['uid'] ?>" class="cmn-toggle cmn-toggle-round-flat cm-toggle-2x js-param-enabler" data-paramUid="<?= $parameter['uid'] ?>" type="checkbox" <?php if ($parameter['enabled'] == 1) { ?>checked<?php } ?>>
