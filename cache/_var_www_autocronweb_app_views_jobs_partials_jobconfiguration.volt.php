        ...
        <div class="panel-body">
            <form>
                ...
                <div class="form-group col-xs-12 col-lg-6">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Last status" value="<?= (empty($job['status']) ? ('0') : ($job['status'])) ?>" readonly>
                ...
                <div class="checkbox col-lg-12 col-md-12">
                    <div class="switch">
                        ...
                        <input id="bench-toggle" class="tgl tgl-skewed" type="checkbox" data-uid="<?= $job['uid'] ?>" <?php if ($job['benchmark'] == 1) { ?>checked<?php } ?>/>
