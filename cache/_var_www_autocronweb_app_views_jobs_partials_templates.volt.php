<div id="templates" class="hidden">
    ...
    <div class="panel panel-primary" id="template-add-step">
        <div class="panel-heading">
            <h3 class="panel-title" style="display: inline-block;width:70%;cursor: pointer;" data-toggle="collapse" data-target="" aria-expanded="false" aria-controls=""><?= $step['stepName'] ?></h3>
            <div class="checkbox pull-right" style="margin-top: -5px;">
                <div class="switch">
                    ...
                    <input class="cmn-toggle cmn-toggle-round-flat js-step-toggle" type="checkbox" checked>
                    <label data-on="On" data-off="Off"></label>
                </div>
            </div>
        </div>
